...
var countStudents = function (students, sandwiches) {
    ...
    while (sandwiches.length > 0) {
        // while length of sandwiches is greater than zero
        if (students[0] == sandwiches[0]) {
            // if first element of students and sandwiches both are same
            ...
            if (movement == students.length) {
                // if movement is equal to length of students then break the loop
                break;
            }
        }
    }
